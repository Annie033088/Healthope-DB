CREATE PROCEDURE pro_healthope_editSingleEntryPassStatusExit
	@singleEntryPassId INT,
	@errorCode INT OUTPUT
AS
BEGIN
	--錯誤碼
	DECLARE @success INT = 1, @ticketInvalid INT = 3
	...
	SET f_status = @statusExit, f_updateTime = SYSUTCDATETIME()
