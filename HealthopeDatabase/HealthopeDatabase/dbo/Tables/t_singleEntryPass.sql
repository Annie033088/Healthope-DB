CREATE TABLE [dbo].[t_singleEntryPass] (
    ...
    [f_status]            TINYINT          CONSTRAINT [DF__t_singleE__f_sta__382F5661] DEFAULT ((3)) NOT NULL,
    [f_firstTimeEntry]    DATETIME2 (3)    CONSTRAINT [DF__t_singleE__f_cre__39237A9A] DEFAULT (sysutcdatetime()) NOT NULL,
